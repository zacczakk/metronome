...
Copy helper scripts from `~/Repos/agents/scripts/` into the current
...
1. Read the canonical version from `~/Repos/agents/scripts/{helper}`.
...
- **Source of truth**: `~/Repos/agents/scripts/` is always canonical.
