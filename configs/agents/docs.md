...
description: >-
  ...
  Invoke when behavior, setup, APIs, config, or workflows changed.
mode: subagent
...
4. Update docs minimally but completely.
5. Flag stale docs, dead links, missing examples, or missing migration notes.
